...
pollster_results <- c(polls$pollster, polls$enddate, polls$rawpoll_clinton[1]/100, sqrt(X_hat*(1-X_hat)/N), X_hat - qnorm(0.975)*se_hat, X_hat + qnorm(0.975)*se_hat)
pollster_results
```
