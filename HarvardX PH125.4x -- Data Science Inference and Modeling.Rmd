...
![you have to keep interested, otherwise](C:/Users/qp/Pictures/From the table that we showed earlier from RealClearPolitics, we saw.png)
...
So everything we have done can easily be adapted to estimate to p minus 1.  Once we have our estimate, X-bar, and our estimate of our standard error of X-bar, we estimate the spread by 2 times X-bar minus 1, *just plugging in the X-bar where you should have a p*.  
![plug in X_bar as the p](C:/Users/qp/Pictures/once we have our estimate x_bar and estimate of standard error, we just plug in x_bar where we should have p.png)
...
![2p-1 or 2*0.48-1](C:/Users/qp/Pictures/thus our estimate of the spread is 0.04.png)
